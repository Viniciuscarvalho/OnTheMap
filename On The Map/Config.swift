...
class Config: NSObject, NSCoding {
    ...
    private func updateConfiguration() {
        ...
        let parameters = [
            Client.Constants.ParameterKeys.ApiKey: Client.Constants.ParameterValues.ParseAPIKey
        ]
        
        /* 2/3. Build the URL, Configure the request */
        let request = NSMutableURLRequest(URL: appDelegate.URLFromParameters(parameters, withPathExtension: "/configuration"))
